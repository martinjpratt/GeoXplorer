...
namespace HoloToolkit.Unity
{
    ...
    public class DirectionIndicator : MonoBehaviour
    {
        ...
        [Range(0.02f, 1.0f)]
        public float MetersFromCursor = 0.02f;
        ...
        // Check if SceneObjects enabled using the Earth gameobject
        private Renderer sceneObjectsRenderer;
        ...
        private GameObject InstantiateDirectionIndicator(GameObject directionIndicator)
        {
            ...
            sceneObjectsRenderer = GameObject.FindGameObjectWithTag("Earth").GetComponent<Renderer>();
